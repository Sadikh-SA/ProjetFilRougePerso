...
class Partenaire extends \App\Entity\Partenaire implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'regCom', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'ninea', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'localisation', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'domaine', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'utilisateurs', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'idCompte', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'depots'];
        }
    ...
    public function getRegCom(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRegCom', []);

        return parent::getRegCom();
    }

    /**
     * {@inheritDoc}
     */
    public function setRegCom(string $regCom): \App\Entity\Partenaire
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRegCom', [$regCom]);

        return parent::setRegCom($regCom);
    }
     ...
     * {@inheritDoc}
     */
    public function setDomaine(string $domaine): \App\Entity\Partenaire
    {
     ...
     * {@inheritDoc}
     */
    public function setIdCompte(\App\Entity\Compte $idCompte): \App\Entity\Partenaire
    {
