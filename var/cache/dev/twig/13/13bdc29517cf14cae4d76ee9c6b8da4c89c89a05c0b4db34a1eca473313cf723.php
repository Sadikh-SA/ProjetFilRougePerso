...
class __TwigTemplate_07f28b098c118ffca34fde873c69653a437627bae2d53a3c438ec43ea60ddb6e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["partenaire"]) || array_key_exists("partenaire", $context) ? $context["partenaire"] : (function () { throw new RuntimeError('Variable "partenaire" does not exist.', 16, $this->source); })()), "regCom", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Ninea</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["partenaire"]) || array_key_exists("partenaire", $context) ? $context["partenaire"] : (function () { throw new RuntimeError('Variable "partenaire" does not exist.', 24, $this->source); })()), "localisation", [], "any", false, false, false, 24), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Domaine</th>
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["partenaire"]) || array_key_exists("partenaire", $context) ? $context["partenaire"] : (function () { throw new RuntimeError('Variable "partenaire" does not exist.', 28, $this->source); })()), "domaine", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "partenaire/show.html.twig", "/var/www/html/ProjetFilRouge/templates/partenaire/show.html.twig");
    }
}
