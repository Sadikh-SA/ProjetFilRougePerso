...
// Returns the private 'App\Repository\PartenaireControllerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PartenaireControllerRepository.php';

return $this->privates['App\\Repository\\PartenaireControllerRepository'] = new \App\Repository\PartenaireControllerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
